...
mydb = pymysql.connect(host="localhost",user="root",password="Password@1234",database='BizCardX')
...
if selected == "Home":
    ...
    with col1:
        col1.image(Image.open("C://Users//Sripriya//Downloads//card.png.jpg"),width = 500)
...
if selected == "Upload and Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join(r"C:\Users\Sripriya\Downloads", uploaded_card.name), "wb") as f:
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img = os.path.join(os.getcwd(), "C://Users//Sripriya//Downloads", uploaded_card.name)
